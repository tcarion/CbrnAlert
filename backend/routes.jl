...
api_routes = Dict(
    ...
    "/flexpart/inputs/:inputId::String/rename" => (f=FlexpartInputsController.rename_input, keyargs=(method = PUT,)),
    ...
    "/flexpart/runs/:runId::String/delete" => (f=FlexpartRunsController.delete_run, keyargs=(method = DELETE,)),
    "/flexpart/runs/:runId::String/rename" => (f=FlexpartRunsController.rename_run, keyargs=(method = PUT,)),
