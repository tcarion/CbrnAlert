...
export interface GeometryElementAllOf { 
    type: GeometryElementAllOf.TypeEnum;
}
export namespace GeometryElementAllOf {
    export type TypeEnum = 'Point' | 'MultiPoint' | 'LineString' | 'MultiLineString' | 'Polygon' | 'MultiPolygon';
